...
@endsection
@section('content')
<div class="card formPage district_manage admikoForm">
            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="title" class="col-md-2 col-form-label">İlçe Adı:</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="title" name="title"  placeholder="İlçe Adı"  value="{{{ old('title', isset($data)?$data->title : '') }}}">
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("admin.district.index",[Request()->admiko_city_id]) }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
