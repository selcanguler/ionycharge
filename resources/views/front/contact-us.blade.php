            ...
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h2>Contact us</h2>
                        <p>We’re always here to help. Contact us if you are experiencing issues with our app or have any
                            questions.</p>
                    </div>
                </div>
                ...
                <div class="row d-flex justify-content-center">
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-start h-100">
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div class="px-2">
                                    ...
                                    <p class="mb-0">+90 542 442 6819</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center p-3">
                                <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                                ...
                                <div class="px-2">
                                    ...
                                    <a class="mb-0" href="mailto:info@ionycharge.com">info@ionycharge.com</a>
                                </div>
                            </div>
                            <div class="d-flex align-items-center p-3">
                                <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                                ...
                                <div class="px-2">
                                    ...
                                    <p class="mb-0">Gazi Mustafa Kemal, Kaynaklar Menemen Izmir Turkiye</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-5 col-xl-4">
                        <div>
                            <form class="p-3 p-xl-4" method="post" action="{{ route('contact-us.post') }}">
                                @csrf
                                <div class="mb-3"><input class="form-control" type="text" id="name-1" name="name"
                                                         placeholder="Name" value="{{ old('name') }}"></div>
                                <div class="mb-3"><input class="form-control" type="email" id="email-1" name="email"
                                                         placeholder="Email" value="{{ old('email') }}"></div>
                                <div class="mb-3"><textarea class="form-control" id="message-1" name="body" rows="6"
                                                            placeholder="Message"
                ...
                <div class="row">
                    <div class="col">
                        <iframe allowfullscreen="" frameborder="0"
                                src="https://maps.google.com/maps?q=38.503678480755994,27.052222655030704&amp;z=12&amp;output=embed" width="100%" height="100%"
